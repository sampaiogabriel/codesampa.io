...
export function OrbitalContactSection() {
  ...
  return (
    <section className="relative flex min-h-[70vh] flex-col items-center justify-center overflow-hidden bg-background py-24">
      ...
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#80808008_1px,transparent_1px),linear-gradient(to_bottom,#80808008_1px,transparent_1px)] bg-size-[32px_32px] mask-[radial-gradient(ellipse_60%_60%_at_50%_50%,#000_70%,transparent_100%)] pointer-events-none" />
      ...
      <div className="container relative z-10 flex flex-col items-center">
        ...
        <div className="relative flex h-[400px] w-[400px] items-center justify-center md:h-[500px] md:w-[500px]">
          ...
          <motion.div
            ...
            className="absolute h-full w-full rounded-full border border-primary/10"
          >
            {/* Satélite 1 */}
