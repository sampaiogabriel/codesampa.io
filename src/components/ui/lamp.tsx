...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        'relative flex min-h-screen flex-col px-4 items-center justify-center overflow-hidden w-full rounded-md z-0',
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 overflow-visible w-120 bg-gradient-conic from-blue-500 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-56 w-120 bg-gradient-conic from-transparent via-transparent to-blue-500 text-white [--conic-position:from_290deg_at_center_top]"
        >
        ...
        <motion.div
          ...
          className="absolute inset-auto z-30 h-36 w-64 -translate-y-24 rounded-full bg-primary blur-2xl"
        ></motion.div>
        <motion.div
          initial={{ width: '15rem' }}
          ...
          className="absolute inset-auto z-50 h-0.5 w-120 -translate-y-28 bg-blue-500"
        ></motion.div>
